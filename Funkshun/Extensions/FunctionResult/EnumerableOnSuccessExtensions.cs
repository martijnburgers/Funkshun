...
namespace Funkshun.Core.Extensions
{
    ...
    public static partial class EnumerableFunctionResultExtensions
    {
        ...
        public static void OnSuccess<TResult>(this IEnumerable<IFunctionResult<TResult>> functionResults, Action successAction)
        {
        ...
        /// <param name="successAction">The action to call when there are no errors.</param>
        /// <exception cref="ArgumentNullException">Thrown when the parameter is null.</exception>
        public static void OnSuccess<TResult>(this IEnumerable<IFunctionResult<TResult>> functionResults,
                                                          Action<IEnumerable<IFunctionResult<TResult>>> successAction)
        {
            if (functionResults == null) throw new ArgumentNullException("functionResults");
            if (successAction == null) throw new ArgumentNullException("successAction");
        ...
        public static TNewResult OnSuccess<TResult, TNewResult>(
            ...
            Func<IEnumerable<IFunctionResult<TResult>>, TNewResult> successFunction)
        {
            if (functionResults == null) throw new ArgumentNullException("functionResults");
        ...
        ///<exception cref="ArgumentNullException">Thrown when the parameters are null.</exception>
        public static void OnSuccess<TResult>(this IEnumerable<IFunctionResult<TResult>> functionResults, Action successAction, Action elseAction)
        {
            if (functionResults == null) throw new ArgumentNullException("functionResults");
            if (successAction == null) throw new ArgumentNullException("successAction");
