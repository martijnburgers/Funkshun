...
namespace Funkshun.Core.Extensions
{
    ...
    public static partial class FunctionResultExtensions
    {
        ...
        public static void OnWarning(this IFunctionResult functionResult, Action warningAction)
        {
        ...
        /// <param name="warningAction">The action to call when there are warnings.</param>
        /// <exception cref="ArgumentNullException">Thrown when the parameter is null.</exception>
        public static void OnWarning<TFunctionReturnType>(this IFunctionResult<TFunctionReturnType> functionResult,
        ...
        /// <exception cref="ArgumentNullException">Thrown when the parameter is null.</exception>
        public static void OnWarning<TFunctionReturnType>(this IFunctionResult<TFunctionReturnType> functionResult,
                                                          Action<IFunctionResult<TFunctionReturnType>> warningAction)
        {
            if (warningAction == null) throw new ArgumentNullException();
        ...
        /// <param name="warningAction">The action to call when there are warnings.</param>
        /// <exception cref="ArgumentNullException">Thrown when the parameter is null.</exception>
        public static void OnWarning(this IFunctionResult functionResult, Action<IFunctionResult> warningAction)
        {
            if (warningAction == null) throw new ArgumentNullException();
        ...
        public static TNewResult OnWarning<TFunctionReturnType, TNewResult>(
            ...
            Func<IFunctionResult<TFunctionReturnType>, TNewResult> warningFunction)
        {
        ...
        /// <returns>A type of TNewResult which is  returned by the func.</returns>
        ///<exception cref="ArgumentNullException">Thrown when the parameters are null.</exception>
        public static TNewResult OnWarning<TNewResult>(this IFunctionResult functionResult,
                                                       Func<IFunctionResult, TNewResult> warningFunction)
        {
        ...
        ///<exception cref="ArgumentNullException">Thrown when the parameters are null.</exception>
        public static void OnWarning(this IFunctionResult functionResult, Action warningAction, Action elseAction)
        {
        ...
        ///<param name="elseAction">The action to call when there are no warnings.</param>
        ///<exception cref="ArgumentNullException">Thrown when the parameters are null.</exception>
        public static void OnWarning(this IFunctionResult functionResult, Action<IFunctionResult> warningAction, Action<IFunctionResult> elseAction)
        {
            if (warningAction == null) throw new ArgumentNullException("warningAction");
            if (elseAction == null) throw new ArgumentNullException("elseAction");
