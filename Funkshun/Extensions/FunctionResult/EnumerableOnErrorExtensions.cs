...
namespace Funkshun.Core.Extensions
{
    ...
    public static partial class EnumerableFunctionResultExtensions
    {
        ...
        public static void OnError<TResult>(this IEnumerable<IFunctionResult<TResult>> functionResults, Action errorAction)
        {
        ...
        /// <param name="errorAction">The action to call when there are errors.</param>
        /// <exception cref="ArgumentNullException">Thrown when the parameter is null.</exception>
        public static void OnError<TResult>(this IEnumerable<IFunctionResult<TResult>> functionResults,
                                                          Action<IEnumerable<IFunctionResult<TResult>>> errorAction)
        {
            if (functionResults == null) throw new ArgumentNullException("functionResults");
            if (errorAction == null) throw new ArgumentNullException("errorAction");
        ...
        public static TNewResult OnError<TResult, TNewResult>(
            ...
            Func<IEnumerable<IFunctionResult<TResult>>, TNewResult> errorFunction)
        {
            if (functionResults == null) throw new ArgumentNullException("functionResults");
        ...
        ///<exception cref="ArgumentNullException">Thrown when the parameters are null.</exception>
        public static void OnError<TResult>(this IEnumerable<IFunctionResult<TResult>> functionResults, Action errorAction, Action elseAction)
        {
            if (functionResults == null) throw new ArgumentNullException("functionResults");
            if (errorAction == null) throw new ArgumentNullException("errorAction");
